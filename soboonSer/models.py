...
class User(models.Model):
    ...
    legion = models.CharField(max_length=255) # 지역
    ...
    modified_time = models.DateTimeField(auto_now=True,blank=True) # 최근 사용자의 정보 변경 시각
    deleted_time = models.DateTimeField(auto_now=True, blank=True) # 사용자 정보 삭제 시각
...
class Category(models.Model):
    ...
    seq = models.IntegerField(max_length=2, null=False) # 카테고리 seq
    created_time = models.DateTimeField(auto_now_add=True, editable=False, blank=True)  # 사용자 회원 가입 시각
    modified_time = models.DateTimeField(auto_now=True, blank=True)  # 최근 사용자의 정보 변경 시각
    deleted_time = models.DateTimeField(auto_now=True, blank=True)  # 사용자 정보 삭제 시각
...
class Post(models.Model):
    ...
    product_url = models.URLField(blank=True) # 상품 링크
    ...
    finished_time = models.DateTimeField(black=True) # 완료 시각
    status = models.CharField(null=False) # 상태
    created_time = models.DateTimeField(auto_now_add=True, editable=False, blank=True)  # 본문 생성 시각
    modified_time = models.DateTimeField(auto_now=True, blank=True)  # 본문 변경 시각
    deleted_time = models.DateTimeField(auto_now=True, blank=True)  # 본문 삭제 시각
...
class Comment(models.Model):
    ...
    modified_time = models.DateTimeField(auto_now=True, blank=True)  # 댓글 변경 시각
    deleted_time = models.DateTimeField(auto_now=True, blank=True)  # 댓글 삭제 시각
    writer_id = models.ForeignKey(
        User,
        on_delete=models.CASCADE,
        null=False
